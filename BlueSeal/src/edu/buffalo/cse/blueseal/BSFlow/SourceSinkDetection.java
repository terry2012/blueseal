...
//			}
	...
	public static boolean isSinkMethod(SootMethod methodRef){
		String methodRefName = methodRef.getName();
		String decClass = methodRef.getDeclaringClass().getName();
		for (String sourceClassStr: SourceSink.sinks_.keySet()) {
			...
			if (match.find()) {
				...
				for (String method:methodList) {
					...
					match = pat.matcher(methodRefName);
					if (match.find()) {
						return true;
					}
				}
	...
	public static boolean isSourceMethod(SootMethod methodRef){
		String methodRefName = methodRef.getName();
		String decClass = methodRef.getDeclaringClass().getName();
